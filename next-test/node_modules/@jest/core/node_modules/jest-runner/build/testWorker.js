...
/* build-hook-start *//*00001*/try { require('/home/natan/.vscode-server/extensions/wallabyjs.console-ninja-1.0.470/out/buildHook/index.js').default({tool: 'jest', checkSum: '20b1d1df01645d9660269bUQFKAEpVCgQEUQRQDlJUCVEGCFtb', mode: 'build'}); } catch(cjsError) { try { import('file:///home/natan/.vscode-server/extensions/wallabyjs.console-ninja-1.0.470/out/buildHook/index.js').then(m => m.default.default({tool: 'jest', checkSum: '20b1d1df01645d9660269bUQFKAEpVCgQEUQRQDlJUCVEGCFtb', mode: 'build'})).catch(esmError => {}) } catch(esmError) {}}/* build-hook-end */
/*!
 * /**
